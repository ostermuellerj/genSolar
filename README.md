...
There are three possible leaf functions (elliptic, acuminate, and cuneate) whose basic shape are described by the below functions when each are reflected across the x-axis. Let _l_ equal the length of the leaf and _w_ equal the width of the leaf.
